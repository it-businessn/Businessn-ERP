...
export const ROLE_HIERARCHY = [
	...
	ROLES.MANAGER,
	ROLES.ADMINISTRATOR,
	ROLES.AUTH_ADMINISTRATOR,
	ROLES.SHADOW_ADMIN,
];

export const ROLE_ACCESS = {
	[ROLES.ENROLLER]: [ROLES.ENROLLER],
	[ROLES.EMPLOYEE]: [ROLES.EMPLOYEE, ROLES.ENROLLER],
	[ROLES.MANAGER]: [ROLES.MANAGER, ROLES.EMPLOYEE, ROLES.ENROLLER],
	[ROLES.ADMINISTRATOR]: [
		ROLES.ADMINISTRATOR,
		ROLES.MANAGER,
		ROLES.EMPLOYEE,
