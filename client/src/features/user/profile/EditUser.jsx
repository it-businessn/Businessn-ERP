...
export default function EditUser() {
	...
	const handleSubmit = async (values) => {
		try {
			const updatedData = await UserService.updateUserById(id, values, user.token);
						...
						<Card>
							<CardBody>
								<Flex>
									...
									>
										<UserProfile user={userData} image="https://tinyurl.com/yhkm2ek8" />
									</Stack>
									<Spacer />
										...
										<Field name="firstName" key="firstName">
											{({ field }) => (
												<FormControl id="firstName">
													...
													<Input defaultValue={userData?.firstName} {...field} />
												</FormControl>
											)}
										</Field>
										<Field name="middleName" key="middleName">
											{({ field }) => (
												<FormControl id="middleName">
													...
													<Input defaultValue={userData?.middleName} {...field} />
												</FormControl>
											)}
										</Field>
										<Field name="lastName" key="lastName">
											{({ field }) => (
												<FormControl id="lastName">
													...
													<Input defaultValue={userData?.lastName} {...field} />
												</FormControl>
											)}
										</Field>
										...
										<Field name="department" key="department">
											{({ field }) => (
												<FormControl id="department">
													...
													<Select placeholder={userData?.department} {...field}>
														{departments.length &&
										...
										<Field name="streetNumber" key="streetNumber">
											{({ field }) => (
												<FormControl id="streetNumber">
													...
													<Input defaultValue={userData?.address.streetNumber} {...field} />
												</FormControl>
											)}
										</Field>
										<Field name="city" key="city">
											{({ field }) => (
												<FormControl id="city">
													...
													<Input defaultValue={userData?.address.city} {...field} />
												</FormControl>
											)}
										</Field>
										<Field name="state" key="state">
											{({ field }) => (
												<FormControl id="state">
													...
													<Input defaultValue={userData?.address.state} {...field} />
												</FormControl>
											)}
										</Field>
										<Field name="postalCode" key="postalCode">
											{({ field }) => (
												<FormControl id="postalCode">
													...
													<Input defaultValue={userData?.address.postalCode} {...field} />
												</FormControl>
											)}
										</Field>
										<Field name="country" key="country">
											{({ field }) => (
												<FormControl id="country">
													...
													<Input defaultValue={userData?.address.country} {...field} />
												</FormControl>
											)}
										</Field>
									</SimpleGrid>
